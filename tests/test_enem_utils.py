...
def test_get_area():
    ...
    assert get_area("Literatura") == "Linguagens, códigos e suas tecnologias"
    assert get_area("Educação Física") == "Linguagens, códigos e suas tecnologias"
    ...
    assert get_area("Biologia") == "Ciências da Natureza e suas tecnologias"
